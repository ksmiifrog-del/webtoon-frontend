    ...
    <header className="sticky top-0 z-50 glass border-b border-wt-border">
      <div className="mx-auto flex h-12 max-w-5xl items-center justify-between px-4">
        ...
        <nav className="hidden md:flex items-center gap-1">
          <NavTab href="/" label="Өдөр тутмын" />
          <NavTab href="/popular" label="Тренд" />
          <NavTab href="/completed" label="Дууссан" />
        </nav>
          ...
          {searchKeyword.length > 0 && searchResults && (
            <div className="mt-2 rounded-lg bg-wt-bg-card border border-wt-border overflow-hidden max-h-64 overflow-y-auto">
              {searchResults.content.length > 0 ? (
                ...
                <div className="px-4 py-4 text-center text-[13px] text-wt-text-muted">Илэрц олдсонгүй</div>
              )}
            </div>
          )}
        </div>
          ...
          <div className="absolute top-0 right-0 bottom-0 w-72 max-w-[80vw] bg-wt-bg-elevated border-l border-wt-border-light slide-in-right flex flex-col">
            ...
            <div className="px-5 pb-5">
              {user ? (
                <>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[11px] text-wt-text-muted">Зоос</span>
                    </div>
                ...
                <div>
                  <p className="text-[13px] text-wt-text-muted mb-4">Нэвтэрч ороод вебтүүнээ уншаарай</p>
            ...
            <nav className="flex-1 overflow-y-auto px-3 py-3">
              <SidebarLink href="/" label="Өдөр тутмын" onClick={() => setSidebarOpen(false)} />
              <SidebarLink href="/popular" label="Тренд" onClick={() => setSidebarOpen(false)} />
              <SidebarLink href="/completed" label="Дууссан" onClick={() => setSidebarOpen(false)} />
              <SidebarLink href="/events" label="Эвент" onClick={() => setSidebarOpen(false)} />
              {user && (
                <SidebarLink href="/mypage" label="Миний хуудас" onClick={() => setSidebarOpen(false)} />
              )}
            </nav>
