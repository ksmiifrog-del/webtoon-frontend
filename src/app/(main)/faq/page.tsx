...
type Category = "Бүгд" | "Ашиглах заавар" | "Зоос/Төлбөр" | "Аккаунт";

interface FaqItem {
  id: number;
  category: Exclude<Category, "Бүгд">;
  question: string;
  answer: string;
}

const CATEGORIES: Category[] = ["Бүгд", "Ашиглах заавар", "Зоос/Төлбөр", "Аккаунт"];

const FAQ_ITEMS: FaqItem[] = [
  {
    id: 1,
    category: "Ашиглах заавар",
    question: "Вэбтүүн яаж үзэх вэ?",
    answer:
  ...
  },
  {
    id: 2,
    category: "Ашиглах заавар",
    question: "Үнэгүй ба төлбөртэй ангийн ялгаа?",
    answer:
  ...
  },
  {
    id: 3,
    category: "Ашиглах заавар",
    question: "Анги яаж худалдаж авах вэ?",
    answer:
  ...
  },
  {
    id: 4,
    category: "Ашиглах заавар",
    question: "Үргэлжлүүлж үзэх функцийг яаж ашиглах вэ?",
    answer:
  ...
  {
    id: 5,
    category: "Зоос/Төлбөр",
    question: "Зоос яаж цэнэглэх вэ?",
    answer:
  ...
  },
  {
    id: 6,
    category: "Зоос/Төлбөр",
    question: "Зоос буцаан авах боломжтой юу?",
    answer:
  ...
  },
  {
    id: 12,
    category: "Аккаунт",
    question: "Аккаунтаа яаж устгах вэ?",
    answer:
    ...
    <div className="min-h-screen bg-wt-bg">
      ...
      <div className="bg-wt-bg-card border-b border-wt-border">
        <div className="mx-auto max-w-4xl px-4 py-8 sm:py-10">
          ...
          <h1 className="text-2xl font-black text-wt-text sm:text-3xl">Түгээмэл асуулт</h1>
          <p className="mt-2 text-sm text-wt-text-secondary">
            Асуултынхаа хариуг доороос аваарай
          </p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-4xl px-4 py-6 sm:py-8">
        ...
        {filtered.length === 0 && (
          <div className="py-16 text-center">
            <p className="text-sm text-wt-text-secondary">Энэ ангилалд асуулт алга.</p>
          </div>
        )}
      </div>
    </div>
